...
public:
    ...
    const string menu[10] = {"Espresso", "Americano", "Cappuccino", "Latte", "FlatWhite", "Macchiato", "BlackTea", "GreenTea", "Cacao", "HotChocolate"};
    int DrinkOption;  // - выбор напитка
    const int prices[10] = {80, 100, 150, 180, 160, 190, 120, 120, 140, 170};
